...
public class ResponseObject implements PerformanceResourceTiming, HttpMessage {
	...
	private HttpBodyContent responseBodyContentData;
	...
	public String getResponseText() throws IOException {
		...
		responseBodyContentData.writeTo(outstream);
	...
	public void setResponseText(String responseText) {
		responseBodyContentData = new HttpTextBodyContent(responseText);
		this.responseText = responseText;
	}
	...
	public HttpBodyContent getBodyContent() {
		return responseBodyContentData;
	}

	public void setBodyContent(HttpBodyContent bodyContent) {
		this.responseBodyContentData = bodyContent;
	}

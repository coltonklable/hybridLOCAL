Feature: TC09_Shop for RoundTrip  in TS, Price, Book, Ticketing, AMOA, SeatMap & AMF in UAPI and Manual Even Exchange on SmartPoint
...
And RoundTrip segments
	...
	Examples:
	      | PCC  | TripType  | FromTo  		 | DepartureDates   | PaxType 			| ContentSource |CabinPreferenceType | Cabin  | AccessGroup                         | returnBrandedFaresInd |
				| 31RB | RoundTrip | ZCO-SCL-ZCO | 100,120 						| 1-ADT 	| GDS 					| 					 |                |A12D96C8-EB29-4443-A27E-18A72C183E87 ||
...
Scenario Outline: Post ticketing - ManualEvenExchange
    ...
    Examples: 
      ...
      | LON     | 31RB  | VoluntaryChange |   2	   |  19Sep  |   y   |

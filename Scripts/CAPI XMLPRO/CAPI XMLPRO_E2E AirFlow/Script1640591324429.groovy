...
DemandTicketResponse = WS.sendRequestAndVerify(findTestObject('XMLSelect_Galileo_Smoke/CAPI E2E Flow/CAPI XMLPRO_Air E2E Flow_1G/OTA_AirDemandTicketRQ', 
        [('Session') : GlobalVariable.Session, ('PCC') : GlobalVariable.PCC1, ('Password') : GlobalVariable.Password, ('Username') : GlobalVariable.Username, ('RecordLoc') : GlobalVariable.RecordLoc]))

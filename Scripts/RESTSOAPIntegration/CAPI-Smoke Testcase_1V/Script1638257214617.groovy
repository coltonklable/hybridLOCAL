...
Response1 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/Availability', [('Username') : GlobalVariable.Username
...
Response11 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/Availability _2', [('Profile') : GlobalVariable.Profile11V
...
Response2 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/BeginSession', [('Username') : GlobalVariable.Username
            , ('PCC') : GlobalVariable.PCC11V, ('Profile') : GlobalVariable.Profile11V, ('Provider') : GlobalVariable.Provider1V
...
Response3 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/PNRBFManagement_Create PNR', 
...
Response4 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/PNRBFManagement_Add Received info', 
        [('Username') : GlobalVariable.Username, ('PCC') : GlobalVariable.PCC11V, ('Provider') : GlobalVariable.Provider1V
            , ('TokenNumber') : GlobalVariable.TokenNumber, ('RecordLoc') : GlobalVariable.RecordLoc]))

WS.verifyResponseStatusCode(Response4, 200)

Response5 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/PNRRetrieve1', [('Username') : GlobalVariable.Username
...
Response6 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/DocProdFareManipulation', 
        [('Username') : GlobalVariable.Username, ('PCC') : GlobalVariable.PCC11V, ('Provider') : GlobalVariable.Provider1V
            , ('TokenNumber') : GlobalVariable.TokenNumber]))

WS.verifyResponseStatusCode(Response6, 200)

Response7 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/PNRRetrieve2', [('Username') : GlobalVariable.Username
            , ('PCC') : GlobalVariable.PCC11V, ('Provider') : GlobalVariable.Provider1V, ('TokenNumber') : GlobalVariable.TokenNumber
            , ('RecordLoc') : GlobalVariable.RecordLoc]))

WS.verifyResponseStatusCode(Response7, 200)

Response8 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/TicketInfoDisplay', [
            ('Username') : GlobalVariable.Username, ('PCC') : GlobalVariable.PCC11V, ('Provider') : GlobalVariable.Provider1V
            , ('TokenNumber') : GlobalVariable.TokenNumber, ('RecordLoc') : GlobalVariable.RecordLoc]))

WS.verifyResponseStatusCode(Response8, 200)

Response10 = WS.sendRequest(findTestObject('XMLSelect_Galileo_Smoke/XmlSelectSoap/CAPI XMLSelect_1V_copy env/Endsession', [('Username') : GlobalVariable.Username
            , ('PCC') : GlobalVariable.PCC11V, ('Provider') : GlobalVariable.Provider1V, ('TokenNumber') : GlobalVariable.TokenNumber]))
